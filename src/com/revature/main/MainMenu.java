...
public class MainMenu {
    ...
    private static void registerFlow() {
        ...
        while (true) {
            System.out.print("Enter Email (press 0 for main menu):  ");
            email = sc.nextLine();
     ...
     // 🔹 Password input with Back option
        ...
        while (true) {
        	 System.out.print("Enter Password (press 0 for main menu): ");
        ...
        while (true) {
            System.out.println("\nSelect Role:");
            System.out.println("Press 0 for Job Seeker");
            System.out.println("Press 1 for Employer");
            System.out.print("Choice: ");
    ...
    private static void forgotPasswordFlow() {
        ...
        if (!isValidAnswer) {
            System.out.println("Security verification failed. The answer you provided is incorrect.");
            return;
        }
        ...
        System.out.println("Password reset successful. You can now sign in with your new password.");
